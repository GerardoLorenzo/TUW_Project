function getcountoffiles {  				## This function return the number of files 
	let count=$(ls -l | egrep '^-' | wc -l)		## in the current folder and saves it in the
}							## count variable
## Start Script
clear
...
getcountoffiles  ## After execute the function, the number of files are stored in count
